<div class="row mb-5 align-items-center">
    ...
    <div class="col-8">
        <label><input type="radio" name="{{$name}}" value="16 - 25" {{$value==""||$value=="16 - 25"? "checked":""}}>16 - 25</label><br>
        ...
        <label><input type="radio" name="{{$name}}" value="66 - 75" {{$value=="66 - 75"? "checked":""}}>66 - 75</label>
    </div>
</div>