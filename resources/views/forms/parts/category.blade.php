<div class="row mb-5 align-items-center">
    ...
    <div class="col-8">
        ...
        <label><input type="radio" name="{{$name}}" value="2" {{$value=="2"? "checked":""}}>Ecclesiastical Assistant</label><br>
        <label><input type="radio" name="{{$name}}" value="3" {{$value=="3"? "checked":""}}>Parish Priest & Ecclesiastical Assistant</label><br>
